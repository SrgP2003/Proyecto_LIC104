...
export function HomePage() {
    ...
    const handleClick = () => {
        navigate('/menu'); {/*Funcion asignada al boton para navegar hacia el menu*/ }
    }
                ...
                <section className="section-lg-home">
                    <article className="art-md-pr container mt-3">
                        ...
                        <div className="div-md-btn">
                            <button onClick={handleClick} className="btn btn-menu btn-primary btn-lg">Ver el menú</button>
                        </div>
                    </article>
                </section>
            </main>
